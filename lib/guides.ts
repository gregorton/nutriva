...
const SEEDS: GuideSeed[] = [
  {
    ...
    tag: "Vitamins",
    title: "How much vitamin D do you actually get in Bangkok?",
    dek: "One of the sunniest cities on earth, and the answer is still “less than you think”. Where the sun goes, and what the label numbers mean.",
    takeaways: [
      "Window glass stops almost all the UVB your skin needs — indoors in the sun is not the same as outdoors.",
      "Labels use both IU and micrograms: 1,000 IU is 25 mcg. Compare the same unit or you will compare nothing.",
    ...
    sections: [
      {
        heading: "The sunniest city, and the indoor day",
        paragraphs: [
          ...
          "Skin makes vitamin D from UVB specifically, and UVB is the part of sunlight that ordinary window glass blocks almost entirely. A desk by a bright window is a pleasant place to work and contributes essentially nothing. Air-conditioned transit, long sleeves against the sun, and sunscreen — all sensible in this climate — subtract from the same total.",
          "None of that makes a supplement compulsory. It does explain why a tropical address is not, by itself, an answer.",
        ],
      },
      {
        heading: "IU, micrograms, and the label arithmetic",
        paragraphs: [
          "Vitamin D is stated two ways, and both appear on shelves here. The conversion is fixed: 40 IU is 1 microgram, so 1,000 IU is 25 mcg and 5,000 IU is 125 mcg. A bottle marked “50 mcg” is a 2,000 IU bottle wearing different clothes.",
          "Two more numbers decide what you are actually buying: the amount per softgel, and the serving size in softgels. A panel reading 5,000 IU per serving with a serving of two softgels is a 2,500 IU softgel.",
        ],
        bullets: [
          ...
          { term: "In oil", detail: "A fat-soluble vitamin in an oil base, or taken with a meal that has fat in it, is the conventional arrangement." },
        ],
      },
      {
        heading: "What the reference intakes say",
        paragraphs: [
          "The commonly published adult reference intake is 600 IU a day, rising to 800 IU past 70, with 4,000 IU generally given as the upper level for regular intake. Those are population figures for healthy adults, not a prescription for one person, and they assume the rest of the diet is doing something.",
          "Higher short courses exist and are a matter for a clinician, not a storefront. If you are pregnant, taking medication that interacts with fat-soluble vitamins, or wondering because of a symptom rather than a habit, a blood test answers the question that guesswork cannot.",
        ],
      },
    ],
  },
  {
    ...
    takeaways: [
      ...
      "Forms differ mainly in how well they are tolerated. The gentlest form you will actually take beats the theoretically best one you stop taking.",
    ],
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "The supplement facts panel is where the honest figure lives, usually written as “Magnesium (as magnesium glycinate) — 200 mg”. That 200 mg is the number to compare. Doing it any other way rewards whichever manufacturer picked the heaviest salt.",
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Loose stools are the ordinary signal that a dose or a form is too much, and splitting it across the day usually settles it. Anyone with reduced kidney function should not be self-dosing magnesium at all — that is a conversation with a doctor, because clearance is the whole issue.",
        ],
      },
    ],
  },
  {
    ...
    dek: "CFU at manufacture is not CFU at swallow, and neither is CFU where it matters. What a live-culture label can and cannot promise.",
    takeaways: [
      "“CFU at manufacture” and “CFU through best-by” are different claims. The second one is the useful one.",
      "Strain, not genus, is what any specific claim attaches to: Lactobacillus rhamnosus GG is a strain; “lactobacillus” is a family tree.",
      "Refrigerated is not automatically better, and shelf-stable is not automatically worse. Storage instructions belong to the product, not the category.",
    ],
    shelf: { category: "gut", refine: "Probiotics", label: "Live cultures on our shelves" },
    sections: [
      {
        heading: "What a CFU number is actually counting",
        paragraphs: [
          "CFU stands for colony-forming units: how many live organisms in a dose can still reproduce. Live is the operative word, and live things decline over time, faster when warm and faster still when damp.",
          "So the same 50 billion can mean two very different products. “50 billion CFU at time of manufacture” is a snapshot of a good day at the factory. “50 billion CFU through the best-by date” is a commitment about the bottle in your hand, which is the only bottle you can swallow.",
        ],
      },
      {
      ...
      {
        heading: "Food, for the same reason",
        paragraphs: [
          "Kimchi, yoghurt with live cultures, fermented vegetables and the more traditional Thai ferments do the same thing without a CFU claim, and they arrive with the rest of the meal. A capsule is a convenience and a way to target a specific studied strain, not a replacement for the food route.",
        ],
      },
    ],
  },
  {
    ...
    dek: "Six lines on a COA tell you whether a batch is worth buying. The rest is formatting.",
    takeaways: [
      "A COA is about one batch. If the lot number on the document is not the lot number on your bottle, it is decoration.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Layouts vary wildly. The content you are looking for does not.",
        ],
        bullets: [
          { term: "Lot and date", detail: "Which batch, tested when. Without both, the rest cannot be checked." },
          { term: "Identity", detail: "Confirmation that the material is what it claims to be — for a botanical, that the species is right." },
      ...
      {
        heading: "Words that look like results, and are not",
        paragraphs: [
          ...
          "Where a supplier will not name a lab or produce a document for the batch you are buying, that is the answer to the question you asked. And to be plain about our own position: Nutriva does not run a laboratory. What we can show you is what the manufacturer publishes on the label, which is why the marks on our product pages are read off the label and nothing more is implied.",
        ],
      },
    ],
  },
  {
    ...
    takeaways: [
      ...
      "Add EPA and DHA per serving, then divide by the number of softgels. That figure is the only fair comparison.",
      "Triglyceride, ethyl ester and phospholipid forms differ; freshness matters more than the argument between them.",
    ],
    ...
    sections: [
      ...
      {
        heading: "How to compare two bottles in ten seconds",
        paragraphs: [
          "Read EPA and DHA per serving, note how many softgels a serving is, and divide. Then multiply by servings per container to see what you are actually paying for.",
        ],
        bullets: [
      ...
      {
        heading: "Freshness, and the smell test",
        paragraphs: [
          "Omega-3s oxidise. Rancid oil tastes and smells like it, and a strongly fishy burp or a bitter capsule is the practical signal most people notice first. Some manufacturers publish oxidation figures — peroxide value, TOTOX — and those are worth more than any marketing adjective. Otherwise, buy a size you will finish, keep it out of the heat, and put opened bottles in the fridge in this climate.",
          "One thing worth flagging plainly rather than burying: fish oil has real interactions, notably with anticoagulant medication. That belongs in a conversation with a pharmacist or doctor before a shopping decision.",
        ],
      },
    ],
  },
  {
    ...
    dek: "The anabolic window turned out to be a barn door. What the daily total looks like, and what a scoop is really worth.",
    takeaways: [
      ...
      "The post-workout “window” is hours wide, not minutes. Spreading protein across the day matters more than sprinting to a shaker.",
    ...
    sections: [
      {
        ...
        paragraphs: [
          "For someone training with weights or doing serious endurance work, sport-nutrition guidance generally lands in the region of 1.6 g of protein per kilogram of body weight per day, with a spread either side depending on who is writing and what the goal is. For a 70 kg person that is roughly 110 g a day, from all sources — a powder is a convenient way to close a gap, not a category of its own.",
          "If the daily total is not there, timing is irrelevant. If it is there, timing is a fine-tuning question.",
        ],
      },
      {
        heading: "The window, honestly",
        paragraphs: [
          "The idea that muscle protein synthesis is only available for thirty minutes after training has not held up. Sensitivity to protein stays elevated for many hours afterwards, and a meal before training is still circulating during it. What the research does support is distribution: a portion of protein at several points across the day, rather than one large evening serving.",
          "Practically, that means eating a normal meal within a couple of hours of training and not treating a shaker as a deadline. Convenience is a real reason to use a powder; panic is not.",
        ],
      },
      {
        heading: "Reading a protein label",
        paragraphs: [
          "Two figures decide value, and neither is the tub size.",
        ],
        bullets: [
          ...
          { term: "Concentrate, isolate, hydrolysate", detail: "Increasing processing, increasing price, decreasing lactose. Isolate is the usual pick for lactose sensitivity." },
